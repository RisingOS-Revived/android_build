...
enforce_rro_product_name := $(subst lineage_,rising_,$(PRODUCT_NAME))
enforce_rro_override_module := $(subst Lineage,Rising,$(subst lineage,rising,$(subst lineageos,rising,$(enforce_rro_source_module))))
